    ...
    <View style={[styles.container, { backgroundColor: isDark ? "#0A0A2A" : "#EEF2FF" }]}>
      <View style={[styles.header, { backgroundColor: BRAND, paddingTop: isWeb ? 72 : insets.top + 16 }]}>
        ...
        <View style={{ flexDirection: "row-reverse", gap: 8 }}>
          <Pressable style={styles.addBtn} onPress={() => router.push("/business-spa/packages" as any)}>
            <Feather name="package" size={18} color="#fff" />
          </Pressable>
          <Pressable style={styles.addBtn} onPress={() => router.push("/business-spa/add-service" as any)}>
