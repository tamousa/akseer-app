...
const PROVIDERS: Provider[] = [
  {
    id: "1",
    name: "مركز سيرين للمساج",
    description: "مركز متخصص في العلاج بالمساج مع أحدث أساليب الاسترخاء العالمية",
    rating: 4.9,
    reviewCount: 842,
    isOpen: true,
    address: "حي العليا، الرياض",
    phone: "920011234",
    workingHours: "السبت - الخميس: 10:00 ص - 10:00 م | الجمعة: 2:00 م - 10:00 م",
    providerId: "massage-1",
    features: ["مختص معتمد", "زيوت عطرية طبيعية", "جناح نسائي", "غرف VIP"],
    services: [
      { name: "مساج سويدي كامل", price: 280, duration: "60 دقيقة" },
      { name: "مساج أروما ثيرابي", price: 320, duration: "75 دقيقة" },
      { name: "مساج حجر ساخن", price: 380, duration: "90 دقيقة" },
      { name: "مساج رياضي", price: 250, duration: "60 دقيقة" },
    ],
  },
  {
    id: "2",
    name: "سبا لوتس الصحي",
    description: "تجربة استرخاء شاملة مع علاجات شرق آسيوية أصيلة",
    rating: 4.8,
    reviewCount: 563,
    isOpen: true,
    address: "حي السليمانية، الرياض",
    phone: "011-4567890",
    workingHours: "يومياً: 9:00 ص - 11:00 م",
    providerId: "massage-2",
    features: ["مساج تايلاندي أصيل", "حمام بخار", "جاكوزي", "باقات للأزواج"],
    services: [
      { name: "مساج تايلاندي", price: 300, duration: "90 دقيقة" },
      { name: "جلسة ريفلكسولوجي", price: 180, duration: "45 دقيقة" },
      { name: "باقة الزوجين", price: 550, duration: "90 دقيقة" },
      { name: "مساج الرأس والكتفين", price: 150, duration: "30 دقيقة" },
    ],
  },
  {
    id: "3",
    name: "مركز الشفاء للعلاج الطبيعي والمساج",
    description: "مساج علاجي طبي بإشراف متخصصين في إزالة الضغط وعلاج الآلام",
    rating: 4.7,
    reviewCount: 319,
    isOpen: false,
    ...
    providerId: "massage-3",
    features: ["مساج طبي علاجي", "علاج آلام الظهر", "أطباء معتمدون", "تأمين صحي"],
    services: [
      { name: "مساج علاجي ظهر وعنق", price: 220, duration: "45 دقيقة" },
      { name: "مساج عميق للعضلات", price: 280, duration: "60 دقيقة" },
      { name: "علاج نقاط الضغط", price: 200, duration: "45 دقيقة" },
      { name: "مساج للحوامل", price: 260, duration: "60 دقيقة" },
    ],
  },
  {
    id: "4",
    name: "أوبرج رويال سبا",
    description: "تجربة فاخرة للمساج في بيئة فندقية راقية مع خدمات VIP",
    rating: 5.0,
    reviewCount: 412,
    isOpen: true,
    address: "فندق القصر، الرياض",
    phone: "011-8901234",
    workingHours: "يومياً: 10:00 ص - 12:00 م",
    providerId: "massage-4",
    features: ["تجربة فاخرة 5 نجوم", "منتجات Elemis", "خدمة خاصة", "حجز VIP"],
    services: [
      { name: "الريتريت الفاخر", price: 800, duration: "120 دقيقة" },
      { name: "مساج الذهب الأبيض", price: 650, duration: "90 دقيقة" },
      { name: "علاج اللافندر الملكي", price: 480, duration: "75 دقيقة" },
    ],
  },
];
...
const OFFERS: Offer[] = [
  {
    id: "1",
    providerName: "مركز سيرين للمساج",
    providerId: "massage-1",
    title: "باقة الاسترخاء الشاملة",
    description: "جلسة مساج سويدي كاملة + أروما ثيرابي + جاكوزي",
    originalPrice: 650,
    discountPrice: 299,
    discountPercent: 54,
    validUntil: "2026-04-30",
    code: "SERENITY54",
    terms: ["صالح لشخص واحد", "حجز مسبق مطلوب قبل 24 ساعة", "غير قابل للاسترداد"],
  },
  {
    id: "2",
    providerName: "سبا لوتس الصحي",
    providerId: "massage-2",
    title: "باقة الزوجين رومانسية",
    description: "جلسة مساج تايلاندي مشترك + إضاءة شمعات + مشروبات",
    originalPrice: 900,
    discountPrice: 490,
    discountPercent: 46,
    validUntil: "2026-05-15",
    code: "LOTUS46",
    terms: ["لشخصين فقط", "في أيام غير الجمعة والسبت", "يشمل مشروبات ترحيبية"],
  },
  {
    id: "3",
    providerName: "مركز الشفاء",
    providerId: "massage-3",
    title: "جلسة 3 مساج بسعر 2",
    description: "احجز 3 جلسات علاجية واحصل على الثالثة مجاناً",
    originalPrice: 660,
    discountPrice: 440,
    discountPercent: 33,
    validUntil: "2026-06-01",
    code: "HEAL33",
    terms: ["الجلسات غير قابلة للتجزئة", "صالح لنفس الشخص", "خلال 3 أشهر من الحجز"],
  },
];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: topPadding + 12, backgroundColor: isDark ? colors.surface : "#fff" }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>{t("المساج والاسترخاء", "Massage & Relaxation")} 💆</Text>
              ...
              {isExpanded && (
                <View style={[styles.expanded, { borderTopColor: colors.border }]}>
                  ...
                  <Pressable
                    ...
                    onPress={() => router.push(`/providers/detail/${provider.providerId}?type=massage` as any)}
                  >
            ...
            {selectedOffer && (
              <>
                ...
                <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
                  ...
                  <View style={[styles.priceCard, { backgroundColor: isDark ? colors.surfaceAlt : "#F0FDF9" }]}>
                  ...
                  <View style={[styles.codeBox, { backgroundColor: isDark ? colors.surfaceAlt : "#F0FDF9", borderColor: ACCENT + "30" }]}>
                    <View>
                  ...
                  <Pressable
                    ...
                    onPress={() => {
                      ...
                      router.push(`/providers/detail/${selectedOffer.providerId}?type=massage` as any);
                    }}
                  >
                    <Feather name="calendar" size={16} color="#fff" />
