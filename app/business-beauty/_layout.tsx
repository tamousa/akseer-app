...
export default function BeautyLayout() {
  ...
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
        tabBarStyle: { backgroundColor: isDark ? "#1A0020" : "#FFF0F6", borderTopColor: BRAND + "30", height: 62, paddingBottom: 8 },
    ...
    >
      ...
      <Tabs.Screen name="services"       options={{ title: t("الخدمات",   "Services"), tabBarIcon: ({ color, size }) => <Feather name="scissors"    size={size} color={color} /> }} />
      ...
      <Tabs.Screen name="beauty-preview" options={{ href: null }} />
