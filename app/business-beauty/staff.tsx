  ...
  return (
    <View style={[s.container, { backgroundColor: isDark ? "#150010" : "#FFF0F6" }]}>
      <View style={[s.header, { backgroundColor: BRAND, paddingTop: isWeb ? 72 : insets.top + 16 }]}>
        <Text style={s.headerTitle}>{t("الموظفات","Staff")} ({STAFF.length})</Text>
        <Pressable style={s.addBtn} onPress={() => Alert.alert(t("إضافة موظفة","Add Staff"), t("سيتم فتح نموذج إضافة موظفة جديدة","A new staff form will open"))}>
