...
const INITIAL_BOOKINGS = [
  {
    id: 1,
    nameAr: "أمل الغامدي",
    nameEn: "Amal Al-Ghamdi",
    serviceAr: "تحليل دم شامل CBC",
    serviceEn: "Complete Blood Count CBC",
    time: "07:30",
    dateAr: "اليوم",
    dateEn: "Today",
    staffAr: "فني ريم",
  ...
  },
  {
    ...
    serviceAr: "فحص السكر وKFT",
    serviceEn: "Glucose & KFT Panel",
    time: "08:00",
    dateAr: "اليوم",
    dateEn: "Today",
    staffAr: "فني علي",
  ...
  },
  {
    id: 3,
    nameAr: "سهيلة الحربي",
    nameEn: "Suhailah Al-Harbi",
    serviceAr: "فحص الغدة الدرقية TSH",
    serviceEn: "Thyroid TSH Test",
    time: "09:00",
    dateAr: "اليوم",
    dateEn: "Today",
    staffAr: "فني ريم",
  ...
  },
  {
    ...
    serviceAr: "تحليل بول كامل",
    serviceEn: "Complete Urinalysis",
    time: "09:30",
    dateAr: "اليوم",
    dateEn: "Today",
    staffAr: "فني علي",
  ...
  },
  {
    id: 5,
    nameAr: "بسمة الشهري",
    nameEn: "Basma Al-Shahri",
    serviceAr: "باقة فحص ما قبل الزواج",
    serviceEn: "Pre-Marriage Panel",
    time: "08:30",
    dateAr: "غداً",
    dateEn: "Tomorrow",
    staffAr: "فني ريم",
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <View style={[s.pageHeader, { paddingTop: topPadding + 10, backgroundColor: colors.background, borderBottomColor: cardBorder }]}>
        ...
        <Text style={[s.pageTitle, { color: colors.text }]}>{t("إدارة الطلبات", "Order Management")}</Text>
